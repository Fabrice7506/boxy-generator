...
export default function LeftContainer() {
  ...
  return (
    <div className="relative mt-20 w-[600px] h-[550px] border rounded-b
       ...
       <div className="flex absolute -translate-y-full -left-[1px]">
        {tabsList.map((tab,index) =>{
            return <button
              ...
              border-gray-300 bg-slate-50 hover:bg-slate-200 text-slate-700 rounded-t focus:outline-none focus:ring-2
